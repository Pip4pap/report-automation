  ...
  return (
    ...
    >
      <div id="report-display-container">
        <section id="report-header">
          <div>
            <p style={{ textIndent: '0pt', textAlign: 'left' }}>
              <span>
                <table style={{ border: 'none', borderCollapse: 'collapse', margin: 0, padding: 0 }}>
                  <tbody>
                    <tr>
                      <td>
                        <img
          ...
          <div>
            <h1 style={{ paddingTop: '2pt', paddingLeft: '54.8pt', textIndent: '0pt', lineHeight: '32pt', textAlign: 'left' }}>LWAGULA MEMORIAL</h1>
            <h2 style={{ paddingLeft: '54.4pt', textIndent: '0pt', lineHeight: '29pt', textAlign: 'left' }}>PRIMARY SCHOOL (LAMPS)</h2>
            <h4 style={{ paddingTop: '2pt', paddingLeft: '54.8pt', textIndent: '0pt', textAlign: 'left' }}>Box 12522, Kampala. Tel : 0755-406702, 0772-406702</h4>
            <p className="s1" style={{ paddingTop: '5pt', paddingLeft: '48.8pt', textIndent: '0pt', textAlign: 'left' }}>REPORT CARD FOR P1-P3 (THEMATIC CURRICULUM)</p>
          </div>
        </section>
        <p style={{ textIndent: '0pt', textAlign: 'left' }}><br /></p>
        <p className="s2" style={{ paddingTop: '4pt', paddingLeft: '6pt', textIndent: '0pt', textAlign: 'left' }}>TERM
          .................................................. YEAR 20 .............. DATE.......................</p>
        <p className="s2" style={{ paddingTop: '6pt', paddingLeft: '6pt', textIndent: '0pt', textAlign: 'left' }}>PUPIL’S
          NAMES........................................................................ CLASS........ENROLMENT.........</p>
        <p style={{ textIndent: '0pt', textAlign: 'left' }} />
        <p className="s2" style={{ paddingTop: '6pt', paddingLeft: '6pt', textIndent: '0pt', lineHeight: '145%', textAlign: 'left' }}>
          AGE.......................................................
          SEX.....................................................................</p>
        ...
        <table style={{ borderCollapse: 'collapse' }} cellSpacing="0">
          <tr style={{ height: '28pt' }}>
            ...
            <td
              style={{
                ...
                borderRightStyle: 'solid',
                borderRightWidth: '1pt',
                borderRightColor: '#231F2'
              }}
              >
              <p className="s3" style={{ paddingTop: '11pt', paddingLeft: '5pt', textIndent: '0pt', textAlign: 'left' }}>LEARNING AREA</p>
            </td>
            <td
              style={{
                width:'39pt',
            ...
            >
              <p
                ...
                >
                MID TERM</p>
              <p className="s6" style={{ paddingLeft: '2pt', textIndent: '0pt', lineHeight: '9pt', textAlign: 'left' }}>SCORES %</p>
            </td>
            <td
              style={{ width:'46pt',
              borderTopStyle: 'solid',
            ...
            >
              <p style={{ textIndent: '0pt', textAlign: 'left' }}><br /></p>
              <p className="s7" style={{ paddingRight: '1pt', textIndent: '0pt', lineHeight: '8pt', textAlign: 'right' }}>END OF TERM</p>
              <p className="s6" style={{ paddingRight: '4pt', textIndent: '0pt', lineHeight: '9pt', textAlign: 'right' }}>SCORES %</p>
            </td>
            <td
              style={{ width:'180pt',
              borderTopStyle: 'solid',
              ...
              borderRightColor: '#231F20'}}
            >
              <p className="s8" style={{ paddingTop: '4pt', paddingLeft: '57pt', textIndent: '0pt', textAlign: 'left' }}>ACHIEVEMENT</p>
            </td>
            <td
              style={{ width:'50pt',
              borderTopStyle: 'solid',
              ...
              borderRightColor: '#231F20'}}
            >
              <p className="s5" style={{ paddingTop: '8pt', paddingLeft: '5pt', textIndent: '0pt', textAlign: 'left' }}>INTITIALS</p>
            </td>
          </tr>
          <tr style={{ height: '29pt' }}>
            <td
              ...
              borderRightColor: '#231F20'}}
            >
              <p className="s9" style={{ paddingTop: '5pt', paddingRight: '1pt', textIndent: '0pt', textAlign: 'right' }}>1.</p>
            </td>
            <td
              ...
              borderRightColor: '#231F20'}}
            >
              <p className="s10" style={{ paddingTop: '7pt', paddingLeft: '5pt', textIndent: '0pt', textAlign: 'left' }}>MATHEMATICS</p>
            </td>
            <td
              style={{ width:'39pt',
              borderTopStyle: 'solid',
          ...
          <tr style={{ height: '36pt' }}>
            ...
            >
              <p className="s9" style={{ paddingTop: '11pt', paddingRight: '1pt', textIndent: '0pt', textAlign: 'right' }}>2.</p>
            </td>
            <td
              style={{ width:'101pt', borderTopStyle: 'solid',borderTopWidth: '1pt',
              borderTopColor: '#231F20',
          ...
          <tr style={{ height: '36pt' }}>
            <td
              ...
              borderRightColor: '#231F20'}}
            >
              <p className="s9" style={{ paddingTop: '9pt', paddingRight: '1pt', textIndent: '0pt', textAlign: 'right' }}>3.</p>
            </td>
            <td
              style={{ width:'101pt', borderTopStyle: 'solid',borderTopWidth: '1pt',
              borderTopColor: '#231F20',
          ...
          <tr style={{ height: '29pt' }}>
            <td
              ...
              borderRightColor: '#231F20'}}
            >
              <p className="s9" style={{ paddingTop: '8pt', paddingRight: '1pt', textIndent: '0pt', textAlign: 'right' }}>4.</p>
            </td>
            <td
              style={{ width:'101pt', borderTopStyle: 'solid',borderTopWidth: '1pt',
              borderTopColor: '#231F20',
          ...
          <tr style={{ height: '34pt' }}>
            <td
              ...
              borderRightColor: '#231F20'}}
            >
              <p className="s9" style={{ paddingTop: '14pt', paddingRight: '1pt', textIndent: '0pt', textAlign: 'right' }}>5.</p>
            </td>
            <td
              style={{ width:'101pt', borderTopStyle: 'solid',borderTopWidth: '1pt',
              borderTopColor: '#231F20',
          ...
          <tr style={{ height: '34pt' }}>
            ...
            >
              <p style={{ textIndent: '0pt', textAlign: 'left' }}><br /></p>
              <p className="s9" style={{ paddingRight: '1pt', textIndent: '0pt', textAlign: 'right' }}>6.</p>
            </td>
            <td
              style={{ width:'101pt', borderTopStyle: 'solid',borderTopWidth: '1pt',
              borderTopColor: '#231F20',
          ...
          <tr style={{ height: '25pt' }}>
            ...
            >
              <p style={{ textIndent: '0pt', textAlign: 'left' }}><br /></p>
              <p className="s9" style={{ paddingLeft: '5pt', textIndent: '0pt', textAlign: 'left' }}>7.</p>
            </td>
            <td
              rowSpan={2}
              style={{
          ...
          <tr style={{ height: '23pt' }}>
            <td
              ...
              borderRightColor: '#231F20'}}
            >
              <p className="s9" style={{ paddingTop: '2pt', paddingRight: '1pt', textIndent: '0pt', textAlign: 'right' }}>8.</p>
            </td>
            <td
              style={{ width:'101pt', borderTopStyle: 'solid',borderTopWidth: '1pt',
              borderTopColor: '#231F20',
        ...
        <p style={{ paddingTop: '8pt', paddingLeft: '9pt', textIndent: '0pt', lineHeight: '157%', textAlign: 'left' }}>
          NEXT TERM BEGINS ON:..................................................... ENDS ON:............................................
        </p>
        <h3 style={{ paddingLeft: '69pt', textIndent: '0pt', lineHeight: '11pt', textAlign: 'left' }}>This report is not valid without
          the Headtacher’s stamp and signature</h3>
      </div>
    </Dialog>
  );
}
